...
You may use standard Python loop iterations or built-in functions as preferred.`,
...
If no second distinct largest element exists (e.g. all elements are equal or length < 2), return \`-1\`.`,
